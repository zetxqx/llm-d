...
<summary><b><i>Click</i></b> here to view the report for `rate=40` from the above example</summary>
  ...
  metrics:
    latency:
      inter_token_latency:
        max: 29.474916078150272
        mean: 0.05538049506079084
        min: 1.1541182175278664e-05
        p0p1: 1.3899896293878555e-05
        p1: 2.071005292236805e-05
        p5: 0.02233297994825989
        p10: 0.02777562802657485
        p25: 0.037467036047019064
        p50: 0.049100630916655064
        p75: 0.05795515002682805
        p90: 0.06893302802927792
        p95: 0.08118522493168712
        p99: 0.12442416895646602
        p99p9: 0.3366200951626633
        units: s/token
      normalized_time_per_output_token:
        max: 64.73547002510168
        mean: 0.14614666314073863
        min: 0.028418988079576192
        p0p1: 0.03194016137843956
        p1: 0.04161357427342329
        p5: 0.043969878043134326
        p10: 0.045847010188456626
        p25: 0.05348034303621782
        p50: 0.05763024756167209
        p75: 0.0650247293052873
        p90: 0.06877838290680861
        p95: 0.11939571755982138
        p99: 1.734064764568568
        p99p9: 2.0023524976622635
        units: s/token
      request_latency:
        max: 69.07507994584739
        mean: 56.99859113020801
        min: 36.307847309159115
        p0p1: 38.48242816239223
        p1: 41.729852358922365
        p5: 43.655233510769904
        p10: 45.19602058024611
        p25: 52.53347536752699
        p50: 57.0671526575461
        p75: 63.09727115597343
        p90: 66.75280722919851
        p95: 68.06174208073644
        p99: 68.86982582402648
        p99p9: 69.026633774245234
        units: s
      time_per_output_token:
        max: 0.06877714196406305
        mean: 0.055380094068536896
        min: 0.03617704800795764
        p0p1: 0.036181957268362645
        p1: 0.03682108880119631
        p5: 0.04095853600087944
        p10: 0.043373180962307384
        p25: 0.05005549438815797
        p50: 0.056466643396415744
        p75: 0.06089888797426829
        p90: 0.066168003353666769
        p95: 0.06776493513155729
        p99: 0.06855981439638184
        p99p9: 0.06869140598334977
        units: s/token
      time_to_first_token:
        max: 29.651758771156892
        mean: 1.5421174571644147
        min: 0.07185727404430509
        p0p1: 0.07566613634536043
        p1: 0.09392176920548082
        p5: 0.10676072119968012
        p10: 0.11390057054813951
        p25: 0.14171329751843587
        p50: 0.17902882292401046
        p75: 0.22530703799566254
        p90: 0.3084977334598088
        p95: 16.03597699283855
        p99: 28.00815083693713
        p99p9: 29.53903618079473
        units: s
    requests:
      failures: 0
      input_length:
        max: 7689.0
        mean: 7584.3611842105265
        min: 7515.0
        p0p1: 7517.076
        p1: 7526.19
        p5: 7538.0
        ...
        p95: 7635.05
        p99: 7668.0
        p99p9: 7687.443000000001
        units: count
      output_length:
        max: 1999.0
        mean: 946.9980263157895
        min: 1.0
        p0p1: 26.076
        p1: 33.19
        p5: 505.95
      ...
      total: 1520
    throughput:
      output_tokens_per_sec: 13933.301006926753
      requests_per_sec: 14.713125708543455
      total_tokens_per_sec: 125522.96052921373
    time:
      duration: 37.56823453307152
  scenario:
    load:
      args:
        api:
...
- **Throughput**: Requests/sec **+132.2%** ; Output tokens/sec **+135.1%**
- **Latency**: TTFT (mean) **-94.4%** ; Request latency (mean) **-41.4%**
- **Per-token speed**: Inter-token latency (mean) **-20.4%**

| Metric | k8s (Mean) | llmd (Mean) | Δ (llmd - k8s) | Δ% vs k8s |
| :--- | :--- | :--- | :--- | :--- |
| Requests/sec | 6.3374 | 14.7131 | +8.3757 | +132.2% |
| Input tokens/sec | 48,014.91 | 111,589.66 | +63,574.75 | +132.4% |
| Output tokens/sec | 5,926.44 | 13,933.30 | +8,006.86 | +135.1% |
| Total tokens/sec | 53,941.35 | 125,522.96 | +71,581.61 | +132.7% |
| Request latency (s) | 97.304 | 56.999 | -40.305 | -41.4% |
| TTFT (s) | 27.695 | 1.542 | -26.153 | -94.4% |
| Inter-token latency (ms) | 69.53 | 55.38 | -14.15 | -20.4% |
