...
- Multiple inference pools deployed in the same namespace via the [Multi-Inference Pool Setup guide](../multi-inference-pool/README.md).
...
- An explicitly annotated HPA for each target Deployment. Integration with an
  ...
  covered by the [KEDA + EPP Metrics guide](../keda-epp-queue/README.md).
