...
* [Diffusion Serving](./diffusion-serving/README.md) (Experimental) - Serve text-to-image diffusion models on vLLM-Omni or SGLang, where the KV-cache and prefix signals that drive LLM routing do not exist.
