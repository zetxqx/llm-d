...
A workload guide provides the recommended, cohesive deployment for serving a production workload on llm-d. Each defines the workload, then composes the relevant [capability building blocks](../foundations/README.md) into one stack tuned to serve it.
